...
var ucapanWaktu = `مساء الخير 🌌`
 ...
 if(time2 < "19:00:00"){
var ucapanWaktu = ` مسااء الخير 🌃`
 }
 if(time2 < "18:00:00"){
var ucapanWaktu = `مساء الخير 🌃`
 }
 if(time2 < "15:00:00"){
var ucapanWaktu = ` اطلع برا 🌅`
 }
 if(time2 < "11:00:00"){
var ucapanWaktu = `صباح الخير🙂 🌄`
 }
 if(time2 < "05:00:00"){
var ucapanWaktu = `صباح العسل🤓 🌄`
 } 
...
tos = ['يعم عييببب','عيب بق','استغفر الله','ربنا يسمحك']
sin =  tos[Math.floor(Math.random() * (tos.length))]
m.reply(sin)
if (m.text) {
bvl = `شوف يعم الادمن نفسو بيشتم 🙂`
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (isCreator) return m.reply(bvl)
        await XeonBotInc.sendMessage(m.chat,
			...
			XeonBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
XeonBotInc.sendMessage(from, {text:`برا❤`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})}
}
...
🙂`
            ...
            m.reply('استني الخصم' + (text ? ` Type The Command Below ${prefix}${command} ${text}` : ''))
            ...
            if (this.game) {
            delete this.game
            XeonBotInc.sendText(m.chat, `لغيتها`, m)
            } else if (!this.game) {
...
*Hi* @${m.mentionedJid[0].split`@`[0]} *Please type accept to accept or type reject to reject`
            ...
            case 'guess': {
                if (!args.join(" ")) throw `مثال : ${prefix + command} song`
if (args[0] === "song") {
...
Cieeee, What's Going On❤️💖👀`
			...
			if (!text) throw `مثال : ${prefix + command} hi|hello`
            ...
            case 'setexif': {
               if (!isCreator) throw mess.owner
               if (!text) throw `مثال : ${prefix + command} packname|author`
          ...
          case 'setbotpp': {
           ...
           case 'setgrouppp': case 'setgruppp': case 'setgcpp': case 'صورهالروم': {
            ...
            case 'tagall': {
                ...
                if (!isBotAdmins) throw mess.botAdmin
                if (!isAdmins) throw mess.admin
let teks = `╚»˙·٠${themeemoji}●♥ منشن للجميع ♥●${themeemoji}٠·˙«╝ 
 ...
 🌿 *Message : ${q ? q : 'empty'}*\n\n`
            ...
            break
	    case 'style': case 'styletext': case 'زخرفهالاسم':{
	    ...
	    break
            ...
            if (!text) throw `Enter Reason for Vote, مثال: *${prefix + command} Handsome Owner*`
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
case 'group': case 'grup': case 'جروب': {
                if (!m.isGroup) throw mess.group
                if (!isBotAdmins) throw mess.botAdmin
                if (!isPremium) throw mess.premime
                if (args[0] === 'close'){
                    await XeonBotInc.groupSettingUpdate(m.chat, 'announcement').then((res) => m.reply(`*م هتعرفو تتكلمو 🤓*`)).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'open'){
                    await XeonBotInc.groupSettingUpdate(m.chat, 'not_announcement').then((res) => m.reply(`*اتكلموووو😜*`)).catch((err) => m.reply(jsonformat(err)))
                } else {
                let buttons = [
...
case 'mute': case 'اخرص': {
                ...
                m.reply(`${XeonBotInc.user.name} قام بمنع الاعضاء من محادثه البوت❤ !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`Not Activated Before`)
                db.data.chats[m.chat].mute = false
                m.reply(`تم قفل الميزه !`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'فعل' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'اقفل' }, type: 1 }
                    ]
...
break
            case 'linkgroup': case 'linkgc': case 'لينكك': case 'grouplink': {
                if (!m.isGroup) throw mess.group
                if (!isBotAdmins) throw mess.botAdmin
            ...
            case 'report': case 'bug': {
            	if (!text) throw `مثال : ${prefix + command} Report an error feature`
            ...
            case 'bctext': case 'broadcasttext': case 'بيسي':
			    if (!isCreator) throw mess.owner
		            if (!text) throw `Enter text`
		                            var data = await store.chats.all()
                            for (let i of data) {
                               XeonBotInc.sendMessage(i.id, {text: `' : ${q}` })
                               await sleep(1000)
                            }
                            break
...
case 'sticker': case 's': case 'stickergif': case 'استيكر': {
            ...
            break
            case 'ebinary': {
            if (!text) throw `مثال : ${prefix + command} text`
...
break
case 'toimage': case 'toimg': case 'حولهاصوره': {
            ...
            break
case 'tomp4': case 'tovideo': case 'حولهافديو': {
                if (!quoted) throw 'Reply Image'
                if (!/webp/.test(mime)) throw `reply sticker with caption *${prefix + command}*`
                m.reply(mess.wait)
		let { webp2mp4File } = require('./lib/uploader')
            ...
            break
            case 'toaud': case 'toaudio': case 'حولهاصوت': {
            ...
            break
            case 'tovn': case 'toptt': case 'حولهاريك':{
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            break
            case 'imagenobg': case 'removebg': case 'حذفخلفيه': {
	    if (!quoted) throw `اعمل ريب علي صوره و اكتب  ${prefix + command}`
	    if (!/image/.test(mime)) throw `اعمل ريب علي صوره و اكتب  ${prefix + command}`
	    if (/webp/.test(mime)) throw `اعمل ريب علي صوره و اكتب  ${prefix + command}`
	    ...
	    case 'yts': case 'بحث': {
            ...
            break
        case 'google': {
                if (!text) throw `مثال : ${prefix + command} fatih arridho`
                ...
                break
case 'video': { 
if (!text) return m.reply(`مثال : ${prefix + command} Stay jb`)
    ...
    case 'play': case 'ytplay': case 'شغل':{
                if (!text) throw `مثال : ${prefix + command} anime whatsapp status`
                let yts = require("youtube-yts")
                let search = await yts(text)
                let anulay = search.videos[Math.floor(Math.random() * search.videos.length)]
                let buttons = [
                    {buttonId: `playmp3 ${anulay.url}`, buttonText: {displayText: '♫ صوت'}, type: 1},
...
break
case 'ytmp3': case 'حمل3': //credit: Ray Senpai ❤️ https://github.com/EternityBots/Nezuko
if (!isPremium) throw mess.premime
const xeonaudp3 = require('./lib/ytdl2')
if (args.length < 1 || !isUrl(text) || !xeonaudp3.isYTUrl(text)) throw `Where's the yt link?\nمثال: ${prefix + command} https://youtube.com/@khufualmoz3g974`
...
break
	    case 'ytmp3xx': case 'ytaudioxx': {
                ...
                if (!text) throw `مثال : ${prefix + command} https://youtube.com/watch?v=PtFMh6Tccag%27 128kbps`
...
case 'lava': case 'rockart': case 'bloodglas': case 'halloween': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpinkart': case 'sand': case 'glue': case '1917': case 'leaves': case 'demon': {
             if (!q) throw `مثال : ${prefix + command} ${global.ownername}`
             m.reply(mess.wait)
             let link
...
if (args.length < 1) throw `مثال :\n${prefix + command} <name>`
if (args[0] === 'glitch') {
if (args.length < 2) throw `مثال :\n${prefix + command + ' ' + args[0]} ${global.ownername}`
...
if(!q) throw `مثال: ${prefix + command} ajg | ea`
m.reply(mess.wait)
  inilogo4 = args.join(" ")
inilogo9 = args.join(" ")
...
if (!isPremium) throw mess.premime
if (!text) return m.reply( `مثال : ${prefix + command} link`)
...
break
        case 'ringtone': {
		if (!text) throw `مثال : ${prefix + command} black rover`
...
`.trim()
            ...
            case 'addmsg': {
                ...
                if (!text) throw `مثال : ${prefix + command} filename`
...
View list of Messages With ${prefix}listmsg`)
            ...
            break
            case 'getmsg': {
                if (!text) throw `مثال : ${prefix + command} file name\n\nView message list with ${prefix}listmsg`
                let msgs = global.db.data.database
...
XeonBotInc.sendContact(m.chat, owner, m)
        ...
        case 'menfess':
			...
			case 'confess':
				...
				if (!text) return m.reply(`*How to use?*\n\Send command ${prefix + command} number|sender|message\n\nمثال ${prefix + command} 91xxxxxxxxxx|handsome here|I have a crush on you\n\nمثال 2 : ${prefix + command} 91xxxxxxxxxx|ur crush|I have a crush on you\n\nDon't worry, privacy is safe><`)
...
if (!isPremium) throw mess.premime
if (args[0] === "on") {
if (AntiLinkTwitter) return m.reply('متفعله')
...
XeonBotInc.sendMessage(from, {text: `ممنوع لينكات ❤`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
m.reply('اتقفلت')
  ...
  await XeonBotInc.sendButtonText(m.chat, buttonsntilink, `اختار❤`, `${global.botname}`, m)
  }
  }
  break
case 'antitoxic': case 'منعشتايم': {
if (!m.isGroup) return m.reply(mess.group)
if (!isBotAdmins) return m.reply(mess.botAdmin)
if (!isAdmins && !isCreator) return m.reply(mess.admin)
if (args[0] === "on") {
if (antiToxic) return m.reply('اتفعلت')
nttoxic.push(from)
...
XeonBotInc.sendMessage(from, {text: `محدش يشتم بق❤!`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
if (!antiToxic) return m.reply('اتقفلت')
...
m.reply('مقفوله❤')
  ...
  await XeonBotInc.sendButtonText(m.chat, buttonsnttoxic, `ميزه شتايم ❤`, `${global.botname}`, m)
  }
  }
  break
case 'autoreply': case 'فرفشهه':{
if (args[0] === "on") {
if (Autoreply) return m.reply('متفعله')
autorep.push(from)
...
XeonBotInc.sendMessage(from, {text: `ا`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
if (!Autoreply) return m.reply('اتقفلت')
...
m.reply('مقفوله')
  ...
  await XeonBotInc.sendButtonText(m.chat, buttonsnttoxic, `اختار ​​​​​​​​​​​​​​​​​​​​​​​​🥰`, `${global.botname}`, m)
  }
  }
  break
case 'antiwame': {
...
case 'hhhcghhbvghbvhhjj':
    ...
    "سبحان الله وبحمده سبحان العظيم مئة مرة في اليوم قارئها غفرت له ذنوبه وأن كانت مثل زبد البحر .",
    "﴿وَاذْكُرِ اسْمَ رَبِّكَ وَتَبَتَّلْ إِلَيْهِ تَبْتِيلًا﴾🌿✨",
    "«اللَّهُمَّ آتِ نُفُوسَنَا تَقْوَاهَا ، وَزَكِّهَا أنْتَ خَيْرُ مَنْ زَكَّاهَا ، أنْتَ وَلِيُّهَا وَمَوْلَاهَا»🌹"
]
              const xeondare = dare[Math.floor(Math.random() * dare.length)]
              bufferdare = await getBuffer(`https://ibb.co/VL8KHTt`)
              XeonBotInc.sendMessage(from, { image: bufferdare, caption: '\n'+ xeondare }, {quoted:m})
              break
                            break
       case 'hfjghjfhfjhjfhfjjfyjfyjfyjyfjyfjfy':
              const truth =[
...
if (!isBotAdmins) return m.reply(mess.botAdmin)
if (!isPremium) throw mess.premime
if (args.length < 1) return m.reply('تم')
if (args[0]  === 'on'){
...
break
case 'lyrics2': {
	    if (!text) return reply(`Use مثال ${prefix}lyrics Despacito`)
	m.reply(mess.wait)
...
console.log(lyrics)
 await XeonBotInc.sendMessage(m.chat, {text:txt},{quoted:m})
    ...
    break
        case 'gimage': {
       if (!text) throw `مثال : ${prefix + command} kaori cicak`
...
case 'image': {
		...
		let { pinterest } = require('./lib/scraperW')
            ...
            break
case 'swm': case 'stickerwm': case 'سرقه': case 'take': {  
...
break
case 'emoji': case 'ايموجيي':{
if (!args.join(" ")) return m.reply('فين ال ايموو')
emoji.get(args.join(" ")).then(async(emoji) => {
let mese = await XeonBotInc.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption: `Made by ${global.botname}`}, {quoted:m})
await XeonBotInc.sendMessage(from, {text:"اعمل ريب وكتب استيكر هتتعمل استيك ​​​​​​​​​​​​​​​​​​​​​​​​🥰"}, {quoted:mese})
})
}
break
case 'volume': case 'دوشه':{
if (!args.join(" ")) return m.reply(`مثال: ${prefix + command} 10`)
...
case 'iphoneemoji': 
case 'ايموايفون': 
if (!q) return m.reply("حط الايمو " + ` ${prefix + command} 😀`)
m.reply(mess.wait)
emote(q, "0")
break
case 'googleemoji': 
...
break
case 'ttp': {
           if (!text) return m.reply(`*مثال : ${prefix + command} hello*`)
...
case 'how': {
            ...
            break
case 'rate': {
            	if (!text) throw `مثال : ${prefix + command} my profile`
...
case 'runtime': {
            ...
            break
case 'handsomecheck':
				if (!text) return m.reply(`Tag Someone, مثال : ${prefix + command} @Xeon`)
...
case 'toqr':{
  ...
  break
case 'ig': case 'instagram': case 'reels': case 'انستجرام':{ //credit: Ray Senpai ❤️ https://github.com/EternityBots/Nezuko
...
case 'pcstick':{
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
if (!text) return reply(`${mess.attack}\nمثال: ${prefix}pcstick 91xxxxxxxxxx`)
xeonOP = { 
        key: { 
            fromMe: false, 
            participant: `0@s.whatsapp.net`, 
...
case 'pcslow': { 
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
                if (!text) return reply(`${mess.attack}\nمثال: ${prefix}pcmass 91xxxxxxxxxx`)
             xeonyh1 = { 
                    key: { 
                        fromMe: false, 
                        participant: `0@s.whatsapp.net`, 
...
case 'pcgcslow': {          
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
                if (!m.isGroup) return m.reply(mess.group)
if (!text) return reply(`${mess.attack}\nمثال: ${prefix}pcgcmass 91xxxxxxxxxx`)
             pmgcmassxeon = { 
                    key: { 
                        fromMe: false, 
                        participant: `0@s.whatsapp.net`, 
...
case 'pcfast':               
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
if (!text) return reply(`${mess.attack}\nمثال: ${prefix}pcinfinite 91xxxxxxxxxx`)
             pcinfinitexeon = { 
                    key: { 
                        fromMe: false, 
                        participant: `0@s.whatsapp.net`, 
            ...
            break
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
                if (!m.isGroup) return m.reply(mess.group)
if (!text) return reply(`${mess.attack}\nمثال: ${prefix}pcgcinfinite 91xxxxxxxxxx`)
             pcgcinfinitexeon = { 
                    key: { 
                        fromMe: false, 
                        participant: `0@s.whatsapp.net`, 
...
`
          ...
          case 'pcbunny': { 
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
if (!text) return reply(`${mess.attack}\nمثال: ${prefix}pcbunny 91xxxxxxxxxx`)
             rabbitxeon = `
///....▓▓▓▓
///..▓▓......▓
///..▓▓......▓▓..................▓▓▓▓
...
`
            ...
            break 
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
                if (!m.isGroup) return m.reply(mess.group)
if (!text) return reply(`${mess.attack}\nمثال: ${prefix}pcgcbunny 91xxxxxxxxxx`)
             bunnypcgcx = `
///....▓▓▓▓
///..▓▓......▓
///..▓▓......▓▓..................▓▓▓▓
...
case 'tqtt': 
throw `https://wa.me/+201121968769`
break
case 'بوت': 
throw `عايز اي 🤓`
break
...
break
case 'استماره' : 
throw `------ *_Uchiha Recipt🩸_*-------
*اهلا وسهلا بكم في نقابتنا المتواضعة✨*
--- *برجاء ملئ الاستمارة* ----
...
*✭📜╎من طرف: (  )*
*--------------------*
*✘يمكنك الخروج فور ملئ الاستمارة*
*✘ممنوع اختيار لقب بنت اذا كنت ولد*
*✘ممنوع اختيار اللقب من انميات اباحية*
------------------------
*_ادارة Uchiha🩸_*`
break
case 'alive': case 'panel': case 'list': case 'menu': case 'help': case 'منيو': {
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let timestampe = speed();
            let latensie = speed() - timestampe
            let xeonezy = `اهلا بيك انا بوت واتس\nاقوم بحمايه الجروبات\nبقدر اعمل استيكر\nبقدر احمل اغاني او فديو \nبشيل علامه مائيه \nبعمل لوجو ب نيمك\nمميزاتي كتيره جداا خش جرب\nللبدا قوم بكتابه كلمه (اوامر) \n او الضغط علي جميع الاوامر`
            let ments = [ownernya, me, ini_mark]        
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'جميع اوامر❤' }, type: 1 },{ buttonId: 'command', buttonText: { displayText: 'اختار اوامر ❤' }, type: 1 },{ buttonId: 'sc', buttonText: { displayText: 'شاتي❤' }, type: 1 }]
            let buttonMessage = {
 ...
 break
	...
	const sections = [{
								...
								"rows": [
									{
										"title": "حجات تافهه🙂😂",
										"description": "ᴹᴿ᭄ Bot Whatsapp ×፝֟͜×",
...
const buttons = [
  {buttonId: 'script', buttonText: {displayText: 'المطور❤'}, type: 1},
...
const buttonMessage = {
    ...
    caption: `═══════✪ المالك ✪═══════
- ${prefix}برايفت
انت بس ال تقدر تستخدم البوت ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}للجميع
الكل يقدر يستخدم البوت ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}خشش
...
════════════════
- ${prefix}بيسي 
بيبعت رساله لكل ال عندو ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}اعملروم
بوت بيعمل جروب ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}اديلوبلوك 
 بيعمل بلوك ل شخص عن طريق @ او الرقم او ريب ​​​​​​​​​​​​​​​​​​​​​​​​🥰
 ════════════════
- ${prefix}فكالبلوك 
بيفك البلوك ل شخص عن طريق @ او الرقم او ريب ​​​​​​​​​​​​​​​​​​​​​​​​🥰
═══════✪ جروب ✪═══════ 	        
- ${prefix}لينكك
بيبعت لينك الجروب ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}صورهالروم
بتعمل ريب علي صوره بيحطها صوره روم ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}اسمالروم
بيغير نيم روم ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
...
═════✪ تحميلات ✪═══════
- ${prefix}تيكتوك
بتحمل فديوهات من تيك توك بدون علامه مائيه ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}تيكتوك1
بتحمل اغاني من تيك توك ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}انستجرام
بينزل فديوهات من انستا ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}ميديافاير
بيحمل من ميديا فاير ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}يوتيوب3
بيحمل اغاني من يوتيوب ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}يوتيوب4
بيحمل فديوهات من ​​​​​​​​​​​​​​​​​​​​​​​​يوتيوب ​​​​​​​​​​​​​​​​​​​​​​​​🥰
═══════✪ البحث ✪═══════
- ${prefix}شغل
بيشغل اسم اغاني ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
...
═══════✪ استيكرات ✪═══════ 
- ${prefix}حولهاصوره
بيحول ال استيم ل صوره ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}استيكر
بيعمل الصوره او فديو استيكر ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}ايموجيي
بيحول ال ايمو ل صوره ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}حولهافديو
بيحول ال استيك ل فديو ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}متحركه
بيحول ال استيك  او فديو ل جيف ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}حولهاريك
بيحول ال اغاني ل ريك ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
- ${prefix}حولهااغنيه
بيحول ريك ل mp3   ​​​​​​​​​​​​​​​​​​​​​​​​🥰
════════════════
